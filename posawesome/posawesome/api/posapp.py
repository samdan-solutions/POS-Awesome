...
def get_items(pos_profile, price_list=None):
    ...
    if items_data:
        ...
        for item in items_data:
            ...
            item_alternatives = frappe.get_all(
                "Alternative Items",
                filters={"parent": item_code},
                fields=["item","parent"],
            )
                ...
                row.update(
                    {
                        ...
                        "item_alternatives":item_alternatives or [],
                        "actual_qty": 0,
...
def update_invoice(data):
    ...
    if invoice_doc.is_return and invoice_doc.return_against:
        ...
        invoice_doc.paid_amount = invoice_doc.invoice_sum or invoice_doc.rounded_total or invoice_doc.grand_total or invoice_doc.total
...
def get_items_details(pos_profile, items_data):
    ...
    if(pos_profile.get("taxes_and_charges")):
        sales_taxes_and_charges = frappe.db.get_list("Sales Taxes and Charges", {"parent":pos_profile.get("taxes_and_charges")}, ["name", "rate", "included_in_print_rate"], ignore_permissions=True)
